import audienceFeatureImage640 from "../../assets/audience-feature-640.webp";
import audienceFeatureImage1080 from "../../assets/audience-feature-1080.webp";
import { whoWeArePillars } from "../content/homeContent";
...
export function AudienceSection() {
  return (
    <section id="who-we-are" className="bg-[#f5f7fa] px-6 py-[4.5rem] md:py-24">
          ...
          >
            <div className="panel-surface h-full overflow-hidden rounded-[0.75rem]">
              <div className="grid h-full lg:grid-rows-[0.62fr_0.38fr]">
                <ImageWithFallback
                  src={audienceFeatureImage1080}
                  srcSet={`${audienceFeatureImage640} 640w, ${audienceFeatureImage1080} 1080w`}
                ...
                <div className="flex h-full flex-col border-t border-[#00458b]/10 bg-white px-6 py-6 sm:px-7">
                  ...
                  <p className="mt-5 max-w-lg text-sm leading-7 text-[#00458b]/76">
                    We are a research organisation that publishes in open journals and
                    conferences, contributes to open source software, and shares our
                    work through public talks and workshops.
                  </p>
                  <p className="mt-5 max-w-lg text-sm leading-7 text-[#00458b]/76">
                    We use our research and engineering expertise to help build custom
                    specialised software for our clients without zero vendor lock-in.
                  </p>
                </div>
              </div>
            </div>
